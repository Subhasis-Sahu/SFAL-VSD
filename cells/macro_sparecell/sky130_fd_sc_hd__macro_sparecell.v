...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_hd__macro_sparecell.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__macro_sparecell.timing.pp.v"
`endif // FUNCTIONAL
...
`else  // FUNCTIONAL
`include "sky130_fd_sc_hd__macro_sparecell.timing.v"
`endif // FUNCTIONAL
