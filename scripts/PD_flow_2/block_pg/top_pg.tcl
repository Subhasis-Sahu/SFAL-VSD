...
# PG strategies
set_pg_strategy core_ring -core  -pattern {{pattern: ring_pattern}{nets: {VDD VSS}}} -blockage {{blocks : all}} -extension {{stop: innermost_ring}} 
set_pg_strategy s_mesh1 -core  -pattern {{pattern: pg_mesh1} {nets: {VDD VSS}}  {offset_start: 10 20} {parameters: 4 80 6 120 3.344 false}} -blockage {{blocks : all}} -extension {{stop: outermost_ring}} 
set_pg_strategy macro_con -macros {pll dac}  -pattern {{name: hm_pattern} {nets: {VDD VSS}}} -blockage {{blocks : all}} 
set_pg_strategy rail_strat -core  -pattern {{name: std_cell_rail} {nets: VDD VSS} } -blockage {{blocks : all}} 
