...
set DB_FILES {/home/subhasis/VSDBabySoC/src/lib/pll.db}
...
create_workspace pll -technology $TECH_FILE -scale_factor 10000
read_lef $LEF_FILES
read_db $DB_FILES
process_workspaces -check_options {-allow_missing} -force -directory CLIBs -output pll.ndm
